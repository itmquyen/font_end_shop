    ...
    <div class="team-wrap">
        ...
        <div class="row team-list">
            <div class="col-sm-4 team-i">
                <p class="team-i-img">
                    <img src="http://placehold.it/360x280" alt="Harold Augustine">
                </p>
            ...
            <div class="col-sm-4 team-i">
                <p class="team-i-img">
                    <img src="http://placehold.it/360x280" alt="Wilson Paden">
                </p>
            ...
            <div class="col-sm-4 team-i">
                <p class="team-i-img">
                    <img src="http://placehold.it/360x280" alt="Murray Heath">
                </p>
